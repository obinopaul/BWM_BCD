...
GMEAN & Geometric mean of recall and specificity: $\sqrt{\mathrm{recall}\cdot\mathrm{specificity}}$. \\
...
Train/test split and train-only standardization & \texttt{run\_training.py}, functions \texttt{split\_dataset}, \texttt{fit\_standardization\_preprocessor}, and \texttt{transform\_with\_preprocessor} \\
\bottomrule
\end{longtable}
...
\item \textbf{evaluation outputs} such as accuracy, GMEAN, MCC, Brier score, and the
